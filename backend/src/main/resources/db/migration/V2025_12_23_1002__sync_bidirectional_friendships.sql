-- =============================================================
-- Ensure all friendship relations are symmetrical (bidirectional)
-- This migration fixes any existing "follower-only" relations
-- =============================================================

-- Emilia <-> Roger, Calin, Emanuel, Stefan, Maria
...
-- Calin <-> Emilia, Roger, Alex, Iustin
