...
public class UserControllerUnitTests {
    ...
    void testGetAllUsers() throws Exception {
        User u1 = new User(UUID.randomUUID(), "Ana", "ana@email.com", "Password_123", 10, "user");
        User u2 = new User(UUID.randomUUID(), "Ion", "ion@email.com", "Password_456", 5, "user");
    ...
    void testGetUserById_Success() throws Exception {
        ...
        User user = new User(id, "Ana", "ana@email.com", "Password_123", 0, "user");
    ...
    void testCreateUser() throws Exception {
        UserCreateRequest req = new UserCreateRequest("Ana", "ana@email.com", "Password_123");
    ...
    void testUpdateUser_Success() throws Exception {
        UUID id = UUID.randomUUID();
        UserUpdateRequest req = new UserUpdateRequest("AnaUpdated","anaupdated@email.com","NewPassword_123",15);
        User updated = new User(id,"AnaUpdated","anaupdated@email.com","NewPassword_123",15, "user");
        UserDTO dto = new UserDTO();
